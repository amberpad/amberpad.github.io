...
const buttonVariants = cva(
  cn(
    'inline-flex items-center gap-1 justify-center whitespace-nowrap rounded-md text-sm font-medium',
  ...
  ),
  {
    variants: {
      variant: {
        default: cn(
          'bg-primary-500 dark:text-primary-foreground rounded-md',
          'dark:text-primary-foreground hover:bg-primary/90'
        ),
        destructive:
